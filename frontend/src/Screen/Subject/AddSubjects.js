    ...
    try {
      ...
      if (editingIndex !== -1) {
        ...
        if (success) {
          ...
          showAlert("Failed to update subject. Please try again.");
        }
      } else {
        // Handle adding a new subject
        const newsubject = {
  ...
  return (
    <div className="add-subject-content">
      ...
      <div className="add-subject-options">
        <div
          className={`option ${selectedOption === "add-subjects" ? "form-active" : ""
            }`}
        ...
        <div
          className={`option ${selectedOption === "student-subject" ? "form-active" : ""
            }`}
